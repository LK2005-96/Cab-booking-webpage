...
def driver():
 ...
 root.title("Login page")
 root.geometry("1300x768")
 label_font = font.Font(root,weight="bold")
 name_label=tk.Label (root,text="Username",font=label_font)
 name_entry=tk.Entry(root)
 password_label=tk.Label(root,text="Password",font=label_font)
 password_entry=tk.Entry(root)
 ...
 def div():
  ...
  if(name=="" and password==""): 
    messagebox.showwarning("showwarning","Enter your name and password")
  elif(name==""):
   messagebox.showwarning("showwarning","Enter your Name")
    ...
    messagebox.showinfo("showwarning","Enter your registered name")
  elif(password not in adminpass):
    messagebox.showinfo("showwarning","Enter your correct password")
  else:
    rupee()
 login=tk.Button(root,text="Log in",font=label_font,command=div)
 login.place(x=680,y=400)
def last():
 root.geometry("1300x768")
 label_font = font.Font(weight="bold")
...
def window3():
 ...
 book=tk.Button(text="Book",font=label_font,command=last).place(x=600,y=540)
def window2():
  root.geometry("1300x768")
